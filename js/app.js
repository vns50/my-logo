...
if (document.querySelector('.goods-slider')) {
	const goodsSliderBox = new Swiper('.goods-slider__box', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.goods-slider__arrow_next',
			prevEl: '.goods-slider__arrow_prev',
		},
		pagination: {
			el: '.goods-slider__fraction',
			type: 'fraction',
		},
	})
}
...
if (document.querySelector('.brands-page')) {
	const brandsPageSlider = new Swiper('.brands-page__slider', {
		observer: true,
		observeParents: true,
		slidesPerView: 5,
		spaceBetween: 0,
		...
		// Arrows
		navigation: {
			nextEl: '.brands-page__arrow_prev',
			prevEl: '.brands-page__arrow_next',
		},
		autoplay: {
...
if (isMobile.any()) {
	let menuTabs = document.querySelectorAll('.menu-page__tab >a');
	for (let index = 0; index < menuTabs.length; index++) {
		const menuTab = menuTabs[index];
		menuTab.addEventListener("click", function (e) {
			menuTab.parentElement.classList.toggle('_active');
			e.preventDefault();
		});
	}
} else {

	let menuTabs = document.querySelectorAll('.menu-page__tab');
	for (let index = 0; index < menuTabs.length; index++) {
		const menuTab = menuTabs[index];

		menuTab.addEventListener("mouseenter", function (e) {
			menuTab.classList.add('_active');
		});
		menuTab.addEventListener("mouseleave", function (e) {
...
let scanPageTitle = document.querySelector('.scan-page__title');
let scanPageClass = document.querySelector('.scan-page__class');
scanPageTitle.addEventListener("click", function (e) {
	scanPageTitle.classList.toggle('_active');
	_slideToggle(scanPageClass);
});




let classScanCheckboxs = document.querySelectorAll('.class-scan__checkbox');

for (let index = 0; index < classScanCheckboxs.length; index++) {
	const classScanCheckbox = classScanCheckboxs[index];

	classScanCheckbox.addEventListener("change", function (e) {
		console.log(classScanCheckbox);
		classScanCheckbox.classList.toggle('_active');

		let classScanActiveCheckboxs = document.querySelectorAll('.class-scan__checkbox._active');

		if (classScanActiveCheckboxs.length > 0) {
			scanPageTitle.classList.add('_class');
			let scanPageAmount = scanPageTitle.querySelector('.scan-page__amount');
			scanPageAmount.innerHTML = scanPageAmount.getAttribute('data-text') + ' ' + classScanActiveCheckboxs.length;
		} else {
			scanPageTitle.classList.remove('_class')
		}
	});
}
//====================================================================
